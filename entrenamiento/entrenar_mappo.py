...
from mi_entorno_3sat_v9_secuencial_comunitario import Entorno3SAT
...
def entrenar():
    ...
    print("=" * 60)
    print("  ENTRENAMIENTO MAPPO - V9 (Secuencial Comunitario)")
    print("=" * 60)
    ...
    checkpoint = CheckpointCallback(
        save_freq=100_000,
        save_path=MODEL_DIR,
        name_prefix="mappo_3sat_v9_comunitario"
    )

    print("\nEntrenando...")
    model.learn(total_timesteps=TOTAL_TIMESTEPS, callback=checkpoint)

    nombre_final = "mappo_3sat_v9_secuencial_comunitario_final"
