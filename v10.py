...
class Entorno3SAT(ParallelEnv):
    ...
    metadata = {"render_modes": ["human"], "name": "voto_3sat_v10_mappo_egoista_libre"}
    ...
    def step(self, actions):
        ...
        for agent in self.agents:
            ...
            satisfecho = any(resultado_leyes[var_idx] == deseo for var_idx, deseo in clausula)
            rewards[agent] = 1.0 if satisfecho else 0.0
